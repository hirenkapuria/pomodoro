...
@NonNullApi
public class StopwatchProjectDependency extends DelegatingProjectDependency {

    @Inject
    public StopwatchProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
